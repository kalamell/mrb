    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body body-padd">
          <?php echo form_open('backend/media/save');?>
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="shortly" rows="5"></textarea>
              </div>


              <div class="form-group">
                <label for="youtubeid">YOUTUBE ID</label>
                <input type="text" class="form-control" id="youtubeid" name="youtubeid" placeholder="">
              </div>
